...
//        logUserOut()
    ...
    @objc func actionButtonTapped() {
        ...
        switch buttonConfig {
        case .tweet:
            buttonNavigation(controller: UploadTweetController(user: user, config: .tweet))
        case .message:
            buttonNavigation(controller: SearchController(config: .messages))
        }
    }
    ...
    func buttonNavigation(controller: UIViewController) {
